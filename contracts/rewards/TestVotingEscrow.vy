...
# APY.Finance modifications:
# Update the constants for testing in reasonable time,
# while keeping magnitudes relatively similar.
#
# WEEK: constant(uint256) = 7 * 86400  # all future times are rounded by week
WEEK: constant(uint256) = 20 * 60  # all future times are rounded by 20 minutes
# MAXTIME: constant(uint256) = 4 * 365 * 86400  # 4 years
MAXTIME: constant(uint256) = 48 * 60 * 60 # 48 hours

...
import {
    IStableSwap4 as IStableSwap
} from "contracts/protocols/curve/interfaces/IStableSwap4.sol";
import {
...
contract IronBankPoolZap is CurveBasePool, CurveSusdV2Constants {
    ...
    uint256 public constant override N_COINS = 4;
    ...
    function _addLiquidity(uint256[] calldata amounts, uint256 minAmount)
        ...
        override
    {
        uint256[N_COINS] memory amounts_ =

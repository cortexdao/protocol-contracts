...
const LOGIC_ADDRESS = "0xAC1231Ee773B5596078C8eD316185766aA1bfa15";
...
async function main(argv) {
  ...
  const contractName = "GovernanceTokenProxy";
  ...
  let apy = await contractFactory
    .connect(safeSigner)
    .deploy(LOGIC_ADDRESS, PROXY_ADMIN_ADDRESS, totalSupply);
  ...
  await hre.run("verify:verify", {
    ...
    constructorArguments: [LOGIC_ADDRESS, PROXY_ADMIN_ADDRESS, totalSupply],
  });
}

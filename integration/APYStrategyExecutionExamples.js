...
const executeAReturnArraySelector = AInterface.getSighash(
  "executeAReturnArray"
);
    ...
    it("Basic Calls", async () => {
      ...
      const trx = await exec.execute([
        ...
        [
          ...
          [0, 0, 0],
          [e_1, e_1, e_1],
          [constants.MAX_UINT256, 2, constants.MAX_UINT256],
        ],
        [
          contractA.address,
          executeAReturnArraySelector,
          [0, 0, 0],
          [e_1],
          [constants.MAX_UINT256, constants.MAX_UINT256, 0],
        ],
      ...
      await expectEvent.inTransaction(trx.tx, contractA, "ExecuteAUint256", {
        a: "1",
      });
      await expectEvent.inTransaction(trx.tx, contractA, "MultiParam", {
        a: "1",
        b: "100",
        c: "1",
      });

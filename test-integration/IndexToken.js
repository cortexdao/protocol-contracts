    ...
    describe(`Deployed value: ${deployedValue}`, () => {
      ...
      describe("deposit", () => {
        ...
        it("Test deposit pass", async () => {
          ...
          expect(await indexToken.balanceOf(randomUser.address)).to.equal(
            mintAmount
          );
      ...
      describe("redeem", () => {
        ...
        it("Test redeem pass", async () => {
          ...
          let underlyerBalance = await underlyer.balanceOf(randomUser.address);
